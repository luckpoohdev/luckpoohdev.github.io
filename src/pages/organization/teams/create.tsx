...
export default function GeneralAppPage() {
  ...
  return (
    <>
      ...
      <Head>
        <title>PayPilot | Teams > Opret</title>
      </Head>
      ...
      <Container maxWidth={/*themeStretch ? false : 'xl'*/false} sx={{ pt: 1.5 }}>
        ...
        <Grid item container xs={12}>
          <Grid item xs={12} md={4}>
            ...
            Her kan du oprette et nyt team
            </Typography>
          </Grid>
          <Grid item container xs={12} md={8} display="flex" justifyContent="flex-end" alignItems="center" spacing={1}>
          <CustomButton onClick={handleCancelCreateNewTeam} icon={<Iconify icon="material-symbols:close-rounded" />}>Afbryd</CustomButton>
          </Grid>
        </Grid>
