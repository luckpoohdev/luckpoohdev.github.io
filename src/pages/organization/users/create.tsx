...
export default function GeneralAppPage() {
  ...
  const handleCancelCreateNewUser = () => {
    router.push(PATH_APP.organization.users.root)
  }
  ...
  return (
    <>
      ...
      <Head>
        <title>PayPilot | Brugere > Opret</title>
      </Head>
      ...
      <Container maxWidth={/*themeStretch ? false : 'xl'*/false} sx={{ pt: 1.5 }}>
        ...
        <Grid item container xs={12}>
          <Grid item xs={12} md={4}>
            ...
            Her kan du oprette en ny bruger
            </Typography>
          </Grid>
          <Grid item container xs={12} md={8} display="flex" justifyContent="flex-end" alignItems="center" spacing={1}>
          <CustomButton onClick={handleCancelCreateNewUser} icon={<Iconify icon="material-symbols:close-rounded" />}>Afbryd</CustomButton>
          </Grid>
        </Grid>
