...
import { GET_ERROR_RATE_WIDGET_DATA } from 'src/queries/widget';
...
export default function ErrorRateWidget({ merchantId, storeId, startPeriod, endPeriod, selectedPeriod }) {
  ...
  const { data, loading } = useQuery(GET_ERROR_RATE_WIDGET_DATA, {
    variables: {
      merchantId,
      storeId,
      startPeriod,
  ...
  return (
    <Card sx={{ display: 'flex', alignItems: 'center', p: 3 }}>
      <Box sx={{ flexGrow: 1 }}>
        <Typography variant="subtitle2" paragraph>Fejlrate</Typography>
