...
import { GET_PAID_TRANSACTIONS_WIDGET_DATA } from 'src/queries/widget';

// ----------------------------------------------------------------------

export default function PaidTransactionsWidget({
  merchantId,
  storeId,
  startPeriod,
  endPeriod,
  ...
  const { data, loading } = useQuery(GET_PAID_TRANSACTIONS_WIDGET_DATA, {
    variables: {
      merchantId,
      storeId,
      startPeriod,
  ...
  return (
    <Card sx={{ display: 'flex', alignItems: 'center', p: 3 }}>
      <Box sx={{ flexGrow: 1 }}>
        <Typography variant="subtitle2" paragraph>Udbetalinger</Typography>
