...
// @mui
import { Card, Box, CardProps, Typography, Stack } from '@mui/material';
import { alpha } from '@mui/material/styles';
// components
import Chart, { useChart } from 'src/components/chart';

import { useQuery } from 'src/hooks/apollo';
import { GET_GATEWAY_COSTS_OVERVIEW_WIDGET_DATA } from 'src/queries/widget';
...
export default function GatewayCostsOverviewWidget({ merchantId, storeId, startPeriod, endPeriod, selectedPeriod }) {
  ...
  const { data, loading } = useQuery(GET_GATEWAY_COSTS_OVERVIEW_WIDGET_DATA, {
    variables: {
      merchantId,
      storeId,
      startPeriod,
  ...
  return (
    <Card sx={{ display: 'flex', alignItems: 'center', p: 3 }}>
      <Box sx={{ flexGrow: 1 }}>
        <Typography variant="subtitle2" paragraph>Samlede gatewayomkostninger</Typography>
