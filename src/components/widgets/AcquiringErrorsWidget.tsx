...
import { GET_ACQUIRING_ERRORS_WIDGET_DATA } from 'src/queries/widget';

// ----------------------------------------------------------------------

export default function AcquiringErrorsWidget({
  merchantId,
  storeId,
  startPeriod,
  endPeriod,
  ...
  const { data, loading } = useQuery(GET_ACQUIRING_ERRORS_WIDGET_DATA, {
    variables: {
      merchantId,
      storeId,
      startPeriod,
  ...
  return (
    <Card sx={{ display: 'flex', alignItems: 'center', p: 3 }}>
      <Box sx={{ flexGrow: 1 }}>
        <Typography variant="subtitle2" paragraph>Indløsningsfejl</Typography>
